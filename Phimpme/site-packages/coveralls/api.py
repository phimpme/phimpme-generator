...
class Coveralls(object):
		...
		* [service_job_id]
		...
		if not self.config.get('repo_token') and not is_travis:
			raise CoverallsException(
				'You have to provide either repo_token in %s, or launch via Travis' % self.config_filename)
	...
	def git_info(self):
		...
		git_info = {'git': {
			...
			'branch': os.environ.get('CIRCLE_BRANCH') or os.environ.get('TRAVIS_BRANCH',
